...
class CreditController extends Controller
{
    ...
    public function generateInvoice($id)
    {
        ...
        $userinfo = User::findOrFail($order->users_id);
...
//            }
        ...
        return view('Invoice.index', ['userinfo'=>$userinfo,'promotion' => $promotion, 'cardsname' => $card_type, 'newcards' => $newcards, 'orderinfo' => $order, 'prod' => $products, 'total' => $final, 'deli' => $order->delivery_cost, 'discount' => $discount, 'freeship' => $newdeli]);
